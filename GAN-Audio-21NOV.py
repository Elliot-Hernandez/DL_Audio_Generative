...
generator = tf.keras.Sequential([
    ...
    layers.Dense(337*1025, activation='tanh'),
    layers.Reshape((337,1025,1))
])

generator.summary()

discriminator = tf.keras.Sequential([
    layers.Flatten(input_shape=(337,1025,1)),
    layers.Dense(512, activation='relu'),
...
for epoch in range(epochs):
    ...
    if epoch % 10 == 0:
        ...
        sf.write(f"/content/drive/MyDrive/data/new_audios_generated_{epoch}.wav", audio_signal, 88200, 'PCM_24')
